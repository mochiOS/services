...
pub(crate) const OP_ACTIVATE_SURFACE: u32 = 11;
...
pub(crate) const OP_APPEARANCE_CHANGED: u32 = 123;
pub(crate) const OP_BEGIN_PROCESS_MODAL: u32 = 124;
pub(crate) const OP_END_PROCESS_MODAL: u32 = 125;
...
pub(crate) const OP_DISPLAY_SET_CURSOR_IMAGE: u32 = 5;
pub(crate) const OP_DISPLAY_SET_CURSOR_POSITION: u32 = 6;
pub(crate) const OP_DISPLAY_PRESENT_GPU_PANEL: u32 = 7;
pub(crate) const OP_DISPLAY_GET_RENDERER_CAPS: u32 = 8;
pub(crate) const OP_DISPLAY_PRESENT_GPU_SCENE: u32 = 9;
pub(crate) const DECOR_EVENT_WINDOW: u32 = 0x5749_4e44;
pub(crate) const DECOR_EVENT_POINTER_BUTTON: u32 = 0x4e54_4244;
pub(crate) const DECOR_EVENT_POINTER_MOTION: u32 = 0x544f_4d50;
pub(crate) const DECOR_EVENT_POINTER_LEAVE: u32 = 0x5641_454c;
pub(crate) const CONTEXT_MENU_EVENT_SHOW: u32 = 0x554e_454d;
pub(crate) const CONTEXT_MENU_EVENT_DISMISS: u32 = 0x5349_444d;
pub(crate) const EVENT_CONTEXT_MENU_RESULT: u32 = 13;
pub(crate) const EVENT_APPEARANCE_CHANGED: u32 = 14;

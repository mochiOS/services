...
use display::{display_claim_present_owner, display_request_info, wait_for_service};
use geometry::{Point, PopupPlacement, Rect, merge_damage, validate_damage_rect};
use input::{PointerSerial, clear_focus_for_surface, handle_input_event, subscribe_input_events};
use protocol::*;
use renderer::{PresentFrame, composite_and_present};
...
use window::{
    ...
    reposition_window_surfaces, send_window_metadata, window_index_by_id, window_index_by_token,
};
